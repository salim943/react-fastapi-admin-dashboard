  ...
  return (
    <div style={style} className="App min-h-screen bg-transparent flex flex-col items-center p-4">
      <section className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6">
        <h2 className="text-2xl font-semibold mb-4">Insert Patiend Data and Detail</h2>
        <form onSubmit={handleInsertData} className="flex flex-col gap-4">
          <h3 className="text-xl font-medium mb-2">Patient Details</h3>
          <input
            type="email"
            placeholder="Email"
          ...
          {todos.map((todo, index) => (
            <div key={index} className="flex items-center gap-2 mb-2">
              <input
                type="text"
                placeholder={`Detail ${index + 1} Title`}
                value={todo.title}
              ...
              <input
                type="text"
                placeholder={`Detail ${index + 1} Description`}
